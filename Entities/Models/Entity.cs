...
namespace Entities.Models
{
    public class Entity : DynamicObject, IXmlSerializable, IDictionary<string, object>
    {
        ...
        public bool ContainsKey(string key) { return _expando.ContainsKey(key); }

        public ICollection<string> Keys => _expando.Keys;

        public bool Remove(string key) { return _expando.Remove(key); }

        public bool TryGetValue(string key, out object value) { return _expando.TryGetValue(key, out value); }
        ...
        public bool Contains(KeyValuePair<string, object> item) { return _expando.Contains(item); }
        ...
        public bool Remove(KeyValuePair<string, object> item) { return _expando.Remove(item); }

        public IEnumerator<KeyValuePair<string, object>> GetEnumerator() { return _expando.GetEnumerator(); }
        ...
        /// <summary>
        /// Called by XmlSerializer to output data shaped responses
        /// https://localhost:5001/api/1.0/SupplierTransactions/4/Transactions?pageNumber=1&pageSize=3&MinPaymentMethod=4&MaxPaymentMethod=4&fields=supplierId,supplierTransactionId,transactionDate
        /// </summary>
